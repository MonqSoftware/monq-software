    ...
    <section id="contato" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          variants={fadeIn}
        >
          <Card className="bg-card border-border/20 hover:shadow-lg hover:shadow-foreground/10 transition-all">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <Button
                    variant="outline"
                    size="lg"
                    className="flex-1 border-border/40 text-foreground hover:bg-accent/20 group"
